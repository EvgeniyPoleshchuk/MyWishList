...
fun AddEditDetailView(
    ...
    val snackMassage = remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            WishTextField("Title", viewModel.wishTitleState,
                onValueChanged = {
            ...
            Button(onClick = {
                if (viewModel.wishTitleState.isNotEmpty() && viewModel.wishDescriptionState.isNotEmpty()) {
                    if (id != 0L) {
                        ...
                        snackMassage.value = "Wish has been created"
                    }
                } else {
                    snackMassage.value = "Enter files to create a wish"
                }
                scope.launch {
                    scaffoldState.snackbarHostState.showSnackbar(snackMassage.value)
                    navController.navigateUp()
                }
